...
Este projeto foi desenvolvido como parte de um desafio da **DIO (Digital Innovation One)** com o objetivo de simular um processo completo de:

- Descoberta de perfil profissional  
...
## 🚀 Etapa 2: Planejamento de Carreira (Agent 2)
